define(function(require, exports, module){
    ...
    utils = {
	     ...
	     *     $(function(){
	     *         semi.utils.isEmpty('dragon');  //返回：false
	     *         semi.utils.isEmpty(undefined); //返回：true
	     *         semi.utils.isEmpty(NaN);       //返回：true
	     *     });
	     * });
	     */
	     ...
	     * define(function(require){
	     *     $(function(){
	     *         semi.utils.isEqual([1,2,3],[0,1,2]);  //返回：false
	     *     });
	     * });
	     */
	     ...
	     * define(function(require){
	     *     $(function(){
	     *         semi.utils.getBrowserWH();  //返回：{w:1024, h:768}
	     *     });
	     * });
	     */
	     ...
	     * define(function(require){
	     *     $(function(){
	     *         semi.browser  //返回：{w:1024（宽度）, h:768（高度）, msie:false（是否IE）, ie6:false（是否IE6）, iev:0（ie版本，非IE返回0）}
	     *     });
	     * });
	     */
        getBrowserInfo: function (){
        	...
        	return $.extend({msie:msie, ie6:ie6, iev:iev},utils.getBrowserWH());
        },
        /**
	     * @function   
	     * @desc 窗口变化执行方法。
	     ...
	     * define(function(require){
	     *     $(function(){
	     *         semi.utils.winResize([{name:semi.utils.getBrowserInfo, param:null},{name:initLayout, param:null}]);
	     *     });
	     * });
	     */
        winResize:function(arr){
            ...
            $(window).bind('resize.semi', function(){
                $.each(arr, function(i, func){
	     ...
	     * define(function(require){
	     *     $(function(){
	     *         semi.utils.gotoUrl('www.semi.cn','_blank');
	     *     });
	     * });
	     */
	     ...
	     * define(function(require){
	     *     $(function(){
	     *         semi.utils.checkId('semiId'); //如果存在semiId0,semiId1,semiId2，则返回：3
	     *     });
	     * });
	     */
	     ...
	     * define(function(require){
	     *     $(function(){
	     *         //链接：http://www.semi.cn?dragon=30
	     *         semi.utils.getUrlParam('dragon'); //返回：30
	     *     });
	     * });
	     */
	     ...
	     *         //图片加载失败替换为404图
	     *         setTimeout(function(){
	     *             semi.utils.checkImg($('.uphoto img'),semi.vr.static + '/v5/images/semiweb/pic/user404_middle.jpg');
	     *             semi.utils.checkImg($('.zphoto img'),semi.vr.static + '/v5/images/semiweb/pic/zao404.jpg');
	     *         },500);
	     *     });
	     * });
	     */     
	     ...
	     * define(function(require){
	     *     $(function(){
	     *         semi.utils.imgloaderror(this, function(){
	     *             this.src = img;
	     *         });
	     *     });
	     * });
	     ...
	     *             semi.utils.addBookmark('微课网','http://www.semi.cn');
	     *         });
	     *     });
	     * });
	     */    
	     ...
	     *     $(function(){
	     *         $('.addbook').click(function(){
	     *             semi.utils.setHome('http://www.semi.cn');
	     *         });
	     *     });
	     * });
	     */    
	     ...
	     * define(function(require){
	     *     $(function(){
	     *         //<a class="addbook" href="http://www.semi.cn">加入收藏夹</a>
	     *         $('.addbook').click(function(){
	     *             semi.utils.stopBubble(e);
	     *         });
	     *     });
	     * });
	     */    
	     ...
	     * define(function(require){
	     *     $(function(){
	     *         semi.utils.newObj(semi.utils.isEmpty(skey)?name:skey,value);
	     *     });
	     * });
	     */    
    	newObj: function(key, value){
    		var obj = new Object();
    		if(!utils.isEmpty(key))eval('obj.'+key+'=value');
    		return obj;
    	},
    	/**
	     * @function   
	     ...
	     * define(function(require){
	     *     $(function(){
	     *         if(semi.utils.inArray(options,semi.ajax)!=-1){seajs.log('已经有啦！')}
	     *     });
	     * });
	     */ 
				...
				for(var j=arr.length-2; j>=i; j--){
					if(type=='asc'){//asc升序
						if(arr[j+1]<arr[j]){
							...
							arr[j+1] = arr[j];
							arr[j] = temp;
							if(!utils.isEmpty(callback) && $.isFunction(callback))callback.call(this,j,j+1);
							exchange = true;
						}
					}else{//desc降序
						if(arr[j+1]>arr[j]){
	     ...
	     *     $(function(){
	     *     	   //示例1：滚动到距页面顶部100px;
	     *         semi.utils.scrollTo(100);
	     *         
	     *         //示例1：滚动到某个div处，并报告；
	     *         semi.utils.scrollTo($('.div').offset().top, function(){
	     *         	    seajs.log('我滚到了！');
	     *         });
	     *     });
	     * });
	     ...
	     * define(function(require){
	     *     $(function(){
	     *         semi.utils.flashChecker();	//返回{hasflash: true, version: 11}
	     *     });
	     * });
	     */
        ...
        stringParse: function(str, obj){
            var argReg = /\{([\w\.]+)\}/g;
            return str.replace(argReg, function(all, idx){
                return obj[idx];
            });
        }/*,
