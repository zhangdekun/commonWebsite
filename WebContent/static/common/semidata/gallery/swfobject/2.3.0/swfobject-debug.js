define("gallery/swfobject/2.3.0/swfobject-debug", [], function(require, exports, module) {
	...
	/**
     * @name swfobject
     * @class 用于在HTML中插入Adobe Flash媒体资源（*.swf文件）的JavaScript模块。
     * @version v2.3.0
     * @example
     ...
     *         }; 
     *         swfobject.embedSWF("test.swf", "content2", "300", "120", "9.0.0", "expressInstall.swf", flashvars, params, attributes); 
     *     });
     * });
     */
    ...
    var swfobject = function() {
	    ...
	    */
        ...
        function callDomLoadFunctions() {
            ...
            try {
                ...
                //hide the span in case someone has styled spans via CSS
	    ...
	    */
        function showExpressInstall(att, par, replaceElemIdStr, callbackFn) {
            ...
            if (obj) {
                ...
                var pt = ua.ie ? "ActiveX" : "PlugIn", fv = "MMredirectURL=" + encodeURIComponent(win.location.toString().replace(/&/g, "%26")) + "&MMplayerType=" + pt + "&MMdoctitle=" + encodeURIComponent(doc.title.slice(0, 47) + " - Flash Player Installation");
	    ...
	    */
        function displayFbContent(obj) {
            if (ua.ie && obj.readyState != 4) {
                ...
                // insert placeholder div that will be replaced by the fallback content
	    ...
	    */
        function createSWF(attObj, parObj, id) {
            ...
            id = getId(id);
            // ensure id is truly an ID and not an element
            if (ua.wk && ua.wk < 312) {
                return r;
            }
            if (el) {
	    ...
	    */
        function hasPlayerVersion(rv) {
            rv += "";
            //Coerce number to string, if needed.
        ...
        return {
	        ...
	        */
            ...
            embedSWF: function(swfUrlStr, replaceElemIdStr, widthStr, heightStr, swfVersionStr, xiSwfUrlStr, flashvarsObj, parObj, attObj, callbackFn) {
                var id = getId(replaceElemIdStr), callbackObj = {
                    success: false,
                    id: id
                };
            ...
            installUrl: '/static/common/js/gallery/swfobject/2.3.0/expressInstall.swf',
            version: "2.3"
        };
    }();
    return swfobject;
